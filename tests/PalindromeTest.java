...
public class PalindromeTest {
    ...
    private boolean isPalindrome(String s) {
        try
        {
            ...
            ArrayListStack<Character> c = new ArrayListStack<>();
            ArrayListStack<Character> c2 = new ArrayListStack<>();
            ...
            else if(c.stack.size() % 2 == 0)
            {
                c2 = c.split(c.stack.size()/2);
                return c.toString().equals(c2.toString());
            }
            else
            {
                c2 = c.split(c.stack.size()/2);
